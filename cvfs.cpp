...
void man(char *name)
{
    ...
    {
        printf("Description : Used to create nwe regular file\n");
    ...
    {
        printf("Description : Used to lis all information of file\n");
        printf("Usage  : ls\n");
    }
...
void DisplayHelp()
{
    ...
    printf("open : To open thee File\n");
    printf("close : To close the File \n");
    printf("closeall : To close all opened files\n");
    printf("read : To Read the contents from file\n");
    printf("write : To Write contents into file\n");
    printf("exit : To Terminating file system\n");
...
int ReadFile(int fd, char *arr, int iSize)
{
    ...
    if (UFDTArr[fd].ptrfiletable->ptrinode->FileType != REGULAR)   -4;
    ...
    while(1)
    {
        ...
        else if(count == 3)
        {
            if(strcmp(command[0],"create") == 0)
            {
                ...
                if(ret == -3)
                    printf("ERROR : File Alerady Exist\n");
                if(ret == -4)
